...
const (
	...
	InstanceSettingKey_WEB_PUSH InstanceSettingKey = 5
)
...
type InstanceSetting struct {
	...
	//	*InstanceSetting_WebPushSetting
...
func (x *InstanceSetting) GetWebPushSetting() *InstanceWebPushSetting {
	if x != nil {
		if x, ok := x.Value.(*InstanceSetting_WebPushSetting); ok {
...
type InstanceSetting_WebPushSetting struct {
	WebPushSetting *InstanceWebPushSetting `protobuf:"bytes,6,opt,name=web_push_setting,json=webPushSetting,proto3,oneof"`
}
...
func (*InstanceSetting_WebPushSetting) isInstanceSetting_Value() {}
...
type InstanceWebPushSetting struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// Whether web push notifications are enabled.
	Enabled bool `protobuf:"varint,1,opt,name=enabled,proto3" json:"enabled,omitempty"`
	// The VAPID private key (base64 URL-safe encoded).
	...
	// The VAPID public key (base64 URL-safe encoded).
...
func (x *InstanceWebPushSetting) Reset() {
	*x = InstanceWebPushSetting{}
	mi := &file_store_instance_setting_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *InstanceWebPushSetting) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*InstanceWebPushSetting) ProtoMessage() {}

func (x *InstanceWebPushSetting) ProtoReflect() protoreflect.Message {
	mi := &file_store_instance_setting_proto_msgTypes[7]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use InstanceWebPushSetting.ProtoReflect.Descriptor instead.
func (*InstanceWebPushSetting) Descriptor() ([]byte, []int) {
	return file_store_instance_setting_proto_rawDescGZIP(), []int{7}
}

func (x *InstanceWebPushSetting) GetEnabled() bool {
	if x != nil {
		return x.Enabled
	}
	return false
...
func (x *InstanceWebPushSetting) GetVapidPrivateKey() string {
	if x != nil {
...
func (x *InstanceWebPushSetting) GetVapidPublicKey() string {
	if x != nil {
...
const file_store_instance_setting_proto_rawDesc = "" +
	"\n" +
	"\x1cstore/instance_setting.proto\x12\vmemos.store\"\xe5\x03\n" +
	...
	"\x14memo_related_setting\x18\x05 \x01(\v2'.memos.store.InstanceMemoRelatedSettingH\x00R\x12memoRelatedSetting\x12O\n" +
	"\x10web_push_setting\x18\x06 \x01(\v2#.memos.store.InstanceWebPushSettingH\x00R\x0ewebPushSettingB\a\n" +
	"\x05value\"\\\n" +
	...
	"\treactions\x18\a \x03(\tR\treactions\"\x88\x01\n" +
	"\x16InstanceWebPushSetting\x12\x18\n" +
	"\aenabled\x18\x01 \x01(\bR\aenabled\x12*\n" +
	"\x11vapid_private_key\x18\x02 \x01(\tR\x0fvapidPrivateKey\x12(\n" +
	"\x10vapid_public_key\x18\x03 \x01(\tR\x0evapidPublicKey*\x7f\n" +
...
var file_store_instance_setting_proto_goTypes = []any{
	...
	(*InstanceWebPushSetting)(nil),          // 9: memos.store.InstanceWebPushSetting
}
var file_store_instance_setting_proto_depIdxs = []int32{
	...
	9, // 5: memos.store.InstanceSetting.web_push_setting:type_name -> memos.store.InstanceWebPushSetting
...
func file_store_instance_setting_proto_init() {
	...
	file_store_instance_setting_proto_msgTypes[0].OneofWrappers = []any{
		...
		(*InstanceSetting_WebPushSetting)(nil),
	}
	type x struct{}
